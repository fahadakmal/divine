    ...
    if (mysqli_num_rows($sql_query_one) == 1) {
        ...
        if (!file_exists('./themes/' . $wo['config']['theme'] . '/reaction/like-sm.png')) {
            ...
            if ($wo['reactions_types'][$sql_fetch_one['reaction']]['is_html'] == 1) {
                ...
                if (!empty($wo['reactions_types'][$sql_fetch_one['reaction']]['imean_small_icon'])) {
                    $reaction_icon = "<div class='inline_post_count_emoji reaction'><img src='{$wo['reactions_types'][$sql_fetch_one['reaction']]['imean_small_icon']}' alt=\"" . $wo['reactions_types'][$sql_fetch_one['reaction']]['name'] . "\"></div>";
                }
            }
       ...
       foreach( $reactions as $key => $val ){
        ...
        if (!file_exists('./themes/' . $wo['config']['theme'] . '/reaction/like-sm.png')) {
            ...
            if ($wo['reactions_types'][$key]['is_html'] == 1) {
                ...
                if (!empty($wo['reactions_types'][$key]['imean_small_icon'])) {
                    $reactions_html .= $first."<div class='inline_post_count_emoji reaction'><img src='{$wo['reactions_types'][$key]['imean_small_icon']}' alt=\"" . $wo['reactions_types'][$key]['name'] . "\"></div></span>";
                }
            }
